...
$.widget('javobyte.rouletteWheel', {
  ...
  options: {
    ...
    colors: [],
    spin_background: $('<img>').attr('src', 'img/spin_background.png')[0]
  },
  ...
  _create: function () {
    ...
    if (canvas.getContext) {
      ...
      this._options.textRadius = (this._options.radius + this._options.innerRadius / 0.3 * 0.2) / 2
  ...
  _draw: function () {
    ...
    ctx.fillStyle = '#FFFFFF'; // central background color
